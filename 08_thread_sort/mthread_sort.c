...
int main(int argc, char **argv)
{
    ...
    /* 2.SORT */
    /* 1st Thread / Sort first half of data */
    pthread_create(&tid[0], NULL, sort_thread, &first_half);
    /* 2nd Thread / Sort second half of data */
    ...
    /* 3.MERGE */
    /* 3rd Thread / Merge the result of two halfs  */
    pthread_create(&tid[2], NULL, merge_thread, &merge_range);

    /* waits for the first thread 	*/
    pthread_join(tid[0], NULL);
    /* waits for the second thread 	*/
    pthread_join(tid[1], NULL);
    /* waits for the third thread 	*/
